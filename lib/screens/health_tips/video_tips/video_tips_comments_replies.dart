...
class VideoTipCommentReply extends StatefulWidget {
  dynamic commentData;
  String eventId;
  VideoTipCommentReply({
    super.key,
  ...
  @override
  _VideoTipCommentReplyState createState() => _VideoTipCommentReplyState();
}

class _VideoTipCommentReplyState extends State<VideoTipCommentReply> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 18),
                    VideoTipWidgets().buildCommentWidget(
                      context: context,
                      ...
                      try {
                        ...
                        if (res['status'] == 'ok') {
                          setState(() {
                            ...
                            // my_log(repliesList.length);
                            // my_log("comment-${res['comment']}");
                          });
                          // setState(() {
                          //   fetchReplies = _replyCommentService
                          //       .getRepliesPostComments(
